...
import web.sample.OriginalUncaughtException;
...
public abstract class LastException {
	...
	public static void SetLastException(String title, String place, String param, String message) {
		_LastExcepTitle = title;
        _LastExcepPlace = place;
        _LastExcepParam = param;
        _LastExcepMessage = message;
